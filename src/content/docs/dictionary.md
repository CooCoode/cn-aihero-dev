---
title: AI 编程术语对照表
description: 72 个 AI 编程核心术语的中英对照与中文解释。中文读者读英文一手资料最大的障碍是术语不统一，这张表给出推荐译名与保留英文的场景。
---
...
术语清单来自 [AI Hero 的 AI Coding Dictionary](https://www.aihero.dev/ai-coding-dictionary)（Matt Pocock）。
**本页中文解释为本站原创撰写，不是该词典的翻译。**
